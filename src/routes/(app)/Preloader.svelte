...
<style lang="postcss">
	...
	:global(html.dom-loading) .preloader-inner::before,
	...
	:global(html.dom-loaded) .preloader {
		visibility: hidden;
	...
	:global(html.dom-loaded) .preloader-inner::before,
	:global(html.dom-loaded) .preloader-inner::after {
		transition-delay: var(--speed-slower);
	}

	:global(html.dom-loaded) .preloader-text-part {
		transition-delay: var(--speed-slower);
	}
